...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col lg:flex-row relative">
      ...
      <div id="whats-happening" className="lg:absolute lg:inset-0 lg:flex lg:items-center lg:justify-end lg:p-4 lg:pr-8">
        <div className="w-full max-w-2xl bg-white bg-opacity-20 backdrop-blur-lg rounded-lg p-4 shadow-lg overflow-y-auto" style={{ height: 'calc(100vh - 2rem)' }}>
          <ChatFeed />
        </div>
      </div>
    </div>
