  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row relative">
      <div className="w-full lg:w-1/2 min-h-screen flex flex-col items-center justify-center p-4 space-y-4">
        <div className="w-full max-w-md bg-white bg-opacity-20 backdrop-blur-lg rounded-lg p-6 shadow-lg mb-8 lg:mb-0">
          <h1 className="text-2xl font-bold mb-4 text-center">Welcome to ChatterBox</h1>
          <AuthForm />
        </div>
        <div className="w-full max-w-md bg-white bg-opacity-20 backdrop-blur-lg rounded-lg p-6 shadow-lg mt-8 lg:mt-0">
      ...
      <div className="w-full lg:w-1/2 min-h-screen flex items-center justify-center relative">
        ...
        <div className="absolute inset-0 flex items-center justify-center p-4 lg:pr-12">
