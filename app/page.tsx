  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row relative">
      <div className="w-full lg:w-1/2 min-h-screen flex flex-col items-center justify-between p-2 lg:p-8">
        <div className="w-full max-w-md bg-white dark:bg-gray-800 bg-opacity-20 dark:bg-opacity-30 backdrop-blur-lg rounded-lg p-4 shadow-lg mb-4 lg:mb-0 flex flex-col items-center justify-center">
        ...
        <div id="try-ai" className="w-full max-w-md bg-white dark:bg-gray-800 bg-opacity-20 dark:bg-opacity-30 backdrop-blur-lg rounded-lg p-4 shadow-lg mt-4 transition-all duration-300 ease-in-out">
      ...
      <div id="whats-happening" className="w-full lg:w-[calc(50%+6cm)] lg:absolute lg:inset-y-0 lg:right-0 lg:flex lg:items-center lg:justify-end p-2 lg:p-8">
        <div className="w-full bg-white dark:bg-gray-800 bg-opacity-20 dark:bg-opacity-30 backdrop-blur-lg rounded-lg p-4 shadow-lg overflow-y-auto" style={{ maxHeight: 'calc(100vh - 4rem)' }}>
          <ChatFeed />
        </div>
      </div>
    </div>
